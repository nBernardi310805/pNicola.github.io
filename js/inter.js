...
function random() {
    let a = document.getElementById('min').valueAsNumber, b = document.getElementById('max').valueAsNumber, c = 0
    ...
    if (document.getElementById('inte').checked && ris == 6) {
        returnaRis(12)
        return
    } else
        returnaRis(ris)
}
function returnaRis(ris) { document.getElementById('risult').innerText = +ris }
/* function inte() {
    let risTruc = 1
    document.getElementById('min').value = '1'
    document.getElementById('max').value = '24'
...
function copyPass() { navigator.clipboard.writeText(document.getElementById('passGen').innerText); }